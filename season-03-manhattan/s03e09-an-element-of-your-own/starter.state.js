...
// присылает пост, и это адрес, написанный не нами.
//
// TODO: поле `at` — время приёма. Его ставит контора, и оно нужно живому
//       «сколько прошло». Объявить его здесь и прочитать в read().
