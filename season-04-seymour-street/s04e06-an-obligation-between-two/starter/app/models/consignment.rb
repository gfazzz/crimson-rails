...
class Consignment < ApplicationRecord
  ...
  # TODO: у перевозки много участков, и читать их надо по порядку пути.
  #       Участок без своей перевозки не значит ничего — в отличие от s04e05,
  #       где у перевозок была цена сами по себе. Признак тот же: есть ли у
  #       связанных записей смысл в одиночку.
  # TODO: и дороги, по которым перевозка прошла, — через участки.
