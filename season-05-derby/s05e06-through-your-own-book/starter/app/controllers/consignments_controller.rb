...
class ConsignmentsController < ApplicationController
  ...
  # TODO: книга перевозок дороги — index: только её бланки, по дате отправки.
  #       Дорога — из адреса; нет такой — 404.

  # TODO: одна перевозка — show — через книгу своей дороги.
  #
  #       Где искать бланк: среди всех перевозок реестра или среди перевозок
  #       этой дороги? Бланк MDL, открытый через книгу MID, — ровно то, что
  #       двадцать лет делала бумажная книга кассы.
  #
  #       Участки перевозки — вместе с их дорогами: страница спрашивает базу
  #       одинаковое число раз, сколько бы участков ни было (s04e07).
